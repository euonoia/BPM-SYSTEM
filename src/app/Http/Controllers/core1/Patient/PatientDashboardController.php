...
class PatientDashboardController extends Controller
{
    public function index()
    {
        ...
        if (!$patient) {
            ...
            return view('core1.patient.dashboard', compact('stats'));
        }
        ...
        return view('core1.patient.dashboard', compact('stats', 'patient', 'upcomingAppointments', 'recentAppointments', 'recentRecords', 'pendingBills'));
    }
    ...
    public function overview()
    {
        ...
        if (!$patient) {
            ...
            return view('core1.patient.overview', compact('stats'));
        }
        ...
        return view('core1.patient.overview', compact('stats', 'patient', 'upcomingAppointments', 'recentAppointments', 'recentRecords', 'pendingBills'));
    }
}
