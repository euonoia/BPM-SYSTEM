...
class BillingDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('core1.billing.dashboard', compact('stats', 'recentBills', 'pendingBills', 'overdueBills', 'revenueByStatus'));
    }
    ...
    public function overview()
    {
        ...
        return view('core1.billing.overview', compact('stats', 'recentBills', 'pendingBills', 'overdueBills', 'revenueByStatus'));
    }
}
