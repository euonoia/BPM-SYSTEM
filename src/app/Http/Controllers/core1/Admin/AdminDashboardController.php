...
namespace App\Http\Controllers\core1\Admin;
...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('core1.admin.dashboard', compact('stats', 'admissionData', 'revenueData', 'recentActivities', 'alerts'));
    }
    ...
    public function overview()
    {
        ...
        return view('core1.admin.overview', compact('stats', 'admissionData', 'revenueData', 'recentActivities', 'alerts'));
    }
