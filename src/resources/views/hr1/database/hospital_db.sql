...
(2, 'Medical Laboratory Technologist', 'Laboratory', 'Main Hospital', 'Full-time', 'Open', DATE_SUB(CURDATE(), INTERVAL 15 DAY), 'Perform complex laboratory tests and analyze results. Maintain laboratory equipment and ensure quality control. Requirements: Bachelor degree in Medical Technology, ASCP certification preferred.', NOW(), NOW()),
(3, 'Physical Therapist', 'Rehabilitation', 'Rehabilitation Center', 'Full-time', 'Open', DATE_SUB(CURDATE(), INTERVAL 10 DAY), 'Provide physical therapy services to patients. Develop treatment plans and monitor progress. Requirements: DPT degree, state licensure required.', NOW(), NOW()),
(4, 'Clinical Pharmacist', 'Pharmacy', 'Main Hospital', 'Full-time', 'Open', DATE_SUB(CURDATE(), INTERVAL 8 DAY), 'Dispense medications, provide drug information, and ensure patient safety. Work with healthcare team. Requirements: PharmD degree, state licensure, hospital experience preferred.', NOW(), NOW()),
(5, 'Radiology Technician', 'Radiology', 'Main Hospital', 'Part-time', 'Open', DATE_SUB(CURDATE(), INTERVAL 5 DAY), 'Operate imaging equipment, position patients, and ensure quality images. Part-time position with flexible schedule. Requirements: Associate degree, ARRT certification.', NOW(), NOW()),
(6, 'Respiratory Therapist', 'Respiratory Care', 'Main Hospital', 'Full-time', 'Closed', DATE_SUB(CURDATE(), INTERVAL 30 DAY), 'Provide respiratory care to patients. Manage ventilators and perform diagnostic tests. Requirements: Associate degree, RRT credential.', NOW(), NOW());
